...
class cl_toolbar :
  ...
  def phi_callback( self ) :
    p = simpledialog.askfloat( "φ", "Value?",
              initialvalue = self.master.phi , minvalue = 0.0 )
  ...
  def theta_callback( self ) :
    t = simpledialog.askfloat( "θ", "Value?",
              initialvalue = self.master.theta , minvalue = 0.0 )
  ...
  def psi_callback( self ) :
    ps = simpledialog.askfloat( "ψ", "Value?",
              initialvalue = self.master.psi , minvalue = 0.0 )
  ...
  def draw_callback( self ) :
    ...
    self.master.ob_world.create_graphic_objects( self.master.ob_canvas_frame.canvas, self.master.m_ModelData, clip, perspective, euler )
